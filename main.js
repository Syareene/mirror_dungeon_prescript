...
const packData = [
    ...
    { text: "変わらない", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/main_story/test.png" },
    ...
    { text: "悪に規定される", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/main_story/test.png" },
    ...
    { text: "心のすれ違う", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/main_story/test.png" },
    { text: "再び開かれたラ・マンチャランド", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/main_story/test.png" },
    { text: "終わらぬ行列", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/main_story/test.png" },
    { text: "夢の終わる", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/main_story/test.png" },
    { text: "四大家門と欲望", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/main_story/test.png" },
    { text: "眺めることしかできない", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/main_story/test.png" },
    { text: "幻惑・彷徨・不信", locations: [3,4], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/9-1.png" },
    { text: "教本", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/main_story/test.png" },
    { text: "剣と作品", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/main_story/test.png" },
    { text: "断ち切れない", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/main_story/test.png" },
    ...
    { text: "時間殺人時間", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/event/test.png" },
    { text: "ワープ特急殺人事件", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/event/test.png" },
    { text: "紫の白昼", locations: [3, 4], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/event/violet_noon.png" },
    { text: "鏡屈折鉄道1号線 -MADNESS-", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/reflection_railway/test.png" },
    { text: "鏡屈折鉄道2号線 -MÖBIUS", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/reflection_railway/test.png" },
    { text: "鏡屈折鉄道3号線 -MirrorclockOrangeroad-", locations: [5], appear6to10: true, appear11to15: true, isActive: true, imagePath: "images/reflection_railway/test.png" },
    { text: "鏡屈折鉄道4号線 -Masquerade- 第3区間", locations: [5], appear6to10: true, appear11to15: true, isActive: true, imagePath: "images/reflection_railway/test.png" },
    { text: "鏡屈折鉄道4号線 -Masquerade- 第4区間", locations: [5], appear6to10: true, appear11to15: true, isActive: true, imagePath: "images/reflection_railway/test.png" },
    { text: "20番区の奇跡 BokGak", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/event/test.png" },
    ...
    { text: "LCB定期診断", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/event/test.png" },
    { text: "肉切骨断 BokGak", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/event/test.png" },
    { text: "深夜清掃", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/event/test.png" },
    { text: "鏡屈折鉄道5号線 -MerryGoRound-", locations: [5], appear6to10: true, appear11to15: true, isActive: true, imagePath: "images/reflection_railway/test.png" },
    { text: "憎悪と絶望", locations: [3, 4], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/event/hatred_despair.png" },
    { text: "時間殺人時間 BokGak", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/event/test.png" },
    { text: "切磋琢春", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/event/test.png" },
    { text: "ワープ特急殺人事件 BokGak", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/event/test.png" },
    { text: "琥珀の夕暮", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/event/test.png" },
    { text: "LCB定期診断 BokGak", locations: [4,5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/event/test.png" },
    { text: "斬るべきもの", locations: [1, 2], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/affinity/slash-1.png" },
    { text: "切り裂く者たち", locations: [4], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/affinity/test.png" },
    { text: "貫くべきもの", locations: [1, 2], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/affinity/piece-1.png" },
    { text: "刺し貫く者たち", locations: [4], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/affinity/test.png" },
    { text: "壊れるもの", locations: [1, 2], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/affinity/blunt-1.png" },
    { text: "壊し砕く者たち", locations: [4], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/affinity/test.png" },
    ...
    { text: "解放された怒り", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/affinity/test.png" },
    ...
    { text: "縛り付ける色欲", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/affinity/test.png" },
    ...
    { text: "止まってしまった怠惰", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/affinity/test.png" },
    ...
    { text: "溢れかえった暴食", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/affinity/test.png" },
    ...
    { text: "沈んだ憂鬱", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/affinity/test.png" },
    ...
    { text: "独善的な傲慢", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/affinity/test.png" },
    ...
    { text: "哀れな嫉妬", locations: [5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/affinity/test.png" },
    { text: "燃え上がる揺らめき", locations: [3], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/keyword/burn-1.png" },
    { text: "火旺の節", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/keyword/test.png" },
    { text: "漏れ出した赤血", locations: [3], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/keyword/blood-1.png" },
    { text: "屍山血海", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/keyword/test.png" },
    { text: "ぐらつく波動", locations: [3], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/keyword/tremor-1.png" },
    { text: "異常震域", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/keyword/test.png" },
    { text: "壊す外力", locations: [3], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/keyword/rupture-1.png" },
    { text: "破竹の勢い", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/keyword/test.png" },
    { text: "沈む疼き", locations: [3], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/keyword/sinking-1.png" },
    { text: "沈潜殺到", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/keyword/test.png" },
    { text: "吐かれた一息", locations: [3], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/keyword/poise-1.png" },
    { text: "循環呼吸", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/keyword/test.png" },
    { text: "満ちゆく動力", locations: [3], appear6to10: false, appear11to15: false, isActive: true, imagePath: "images/keyword/charge-1.png" },
    { text: "霹靂閃電", locations: [4, 5], appear6to10: true, appear11to15: false, isActive: true, imagePath: "images/keyword/test.png" },
    { text: "N社 新九人会", locations: [], appear6to10: false, appear11to15: true, isActive: true, imagePath: "images/extreme/test.png" },
    { text: "開花する緑林", locations: [], appear6to10: false, appear11to15: true, isActive: true, imagePath: "images/extreme/test.png" },
    { text: "3号線 - 終着駅", locations: [], appear6to10: false, appear11to15: true, isActive: true, imagePath: "images/extreme/test.png" },
    { text: "永劫のくびき", locations: [], appear6to10: false, appear11to15: true, isActive: true, imagePath: "images/extreme/test.png" },
    { text: "う・み・ダ・かに・バル", locations: [], appear6to10: false, appear11to15: true, isActive: true, imagePath: "images/extreme/test.png" },
    { text: "終わりなき袋小路", locations: [], appear6to10: false, appear11to15: true, isActive: true, imagePath: "images/extreme/test.png" },
    { text: "血鬼になれなかった者たち", locations: [], appear6to10: false, appear11to15: true, isActive: true, imagePath: "images/extreme/test.png" },
    { text: "美しい声", locations: [], appear6to10: false, appear11to15: true, isActive: true, imagePath: "images/extreme/test.png" },
    { text: "緑の黎明", locations: [], appear6to10: false, appear11to15: true, isActive: true, imagePath: "images/extreme/test.png" },
    { text: "とある図書館の、ある本の中へ", locations: [], appear6to10: false, appear11to15: true, isActive: true, imagePath: "images/extreme/test.png" },
];
